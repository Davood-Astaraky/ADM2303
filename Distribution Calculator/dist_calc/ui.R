...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    helpText("Source code available on" , a(href="??", target="_blank", "GitHub.")),
    helpText("Codes are adopted based on the work of Dr. Mine Cetinkaya-Rundel, Duke university,in collaboration with "),  a(href="https://stat.duke.edu/people/brittany-cohen", target="_blank", "Brittany Cohen.")),
